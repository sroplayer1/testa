<?php if($row->banner_image_id): ?>
    <div class="bravo_banner" style="background: url('<?php echo e($row->getBannerImageUrlAttribute('full')); ?>')">
        <div class="container">
...
<?php /**PATH C:\wamp64\www\Ultimate-Booking-System-master\modules/Tour/Views/frontend/layouts/details/tour-banner.blade.php ENDPATH**/ ?>